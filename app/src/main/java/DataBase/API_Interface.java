...
public interface API_Interface {
    ...
    Call<Register_Data> updateproduct(@Field("pname") String name, @Field("pprice") String price, @Field("pdes") String pdes,  @Field("id") String id,@Field("imagedata") String imagedata);
